...
std::string board_get_davie_device_attestation_json()
{
    ...
    cJSON_AddStringToObject(wake, "engine", "multinet_async");
    cJSON_AddStringToObject(wake, "input_signal", "raw_microphone_mono");
    cJSON_AddStringToObject(wake, "segmentation", "adaptive_rms");
    cJSON_AddStringToObject(
        wake,
        "inference_policy",
        "bounded_candidate_async_multinet");
    ...
    cJSON_AddStringToObject(
        wake,
        "aec_scope",
        "conversation_audio_after_wake");
    add_bool(wake, "noise_suppression_active", false);
    cJSON_AddStringToObject(
        wake,
        "noise_suppression_reason",
        "idle_wake_uses_raw_mono_bounded_candidates");
